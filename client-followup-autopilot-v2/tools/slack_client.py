...
def post_draft_for_review(project_name, client_name, subject, body_preview, draft_id, language,
    ...
    Incluye botones de:
      - ✅ Enviar: Envía el draft directamente desde Slack
      - ✏️ Editar en Gmail: Abre el borrador en Gmail para editarlo

    Args:
        project_name: Nombre del proyecto
        client_name: Nombre del cliente
        subject: Asunto del email
        body_preview: Primeros 300 chars del cuerpo
        draft_id: Gmail Draft ID
        language: ES/EN/PT
        recipient_email: Email del destinatario
        sender_email: Email del remitente
        stage: Etapa de seguimiento (1-4)
        cc: Emails en copia

    Returns:
        Resultado del mensaje o None
    """
    ...
    stage_name = {1: "Recordatorio", 2: "Segundo aviso", 3: "Urgente", 4: "Escalamiento"}.get(stage, f"Etapa {stage}")
    ...
    blocks = [
        {
            "type": "header",
            "text": {"type": "plain_text", "text": f"{stage_emoji} Borrador de Follow-Up — Etapa {stage}", "emoji": True}
        },
        {
            "type": "section",
            "fields": [
    ...
    blocks.extend([
        ...
        {
            "type": "section",
            "text": {"type": "mrkdwn", "text": f"*Vista previa:*\n```{body_preview[:500]}```"}
        },
        {"type": "divider"},
    ])
    ...
    blocks.append({
        "type": "context",
        "elements": [
            {"type": "mrkdwn", "text": "💡 *Enviar:* envía el correo directamente | *Editar:* abre Gmail para modificar antes de enviar"}
        ]
    })
